...
impl Pack for Trade {
    ...
    fn pack_into_slice(&self, dst: &mut [u8]) {
        ...
        is_initialized[0] = *is_initialized as u8;
        is_locked[0] = *is_locked as u8;
...
impl Pack for Item {
    ...
    fn unpack_from_slice(src: &[u8]) -> Result<Self, ProgramError> {
        ...
        let (
            ...
            eyes,
            owner,
        ) = array_refs![src, 1, 8, 8, 8, 8, 8, 8, 32, 8, 32, 32];
        let is_initialized = match is_initialized {
            [0] => false,
            [1] => true,
            _ => return Err(ProgramError::InvalidAccountData),
        ...
        Ok(Item { 
            is_initialized,
            body_r: u8::from_le_bytes(*amount),
            body_g: u8::from_le_bytes(*amount),
            body_b: u8::from_le_bytes(*amount),
            stripe_r: u8::from_le_bytes(*amount),
            stripe_g: u8::from_le_bytes(*amount),
            stripe_b: u8::from_le_bytes(*amount),
            hat: u32::from_le_bytes(*amount),
            emotion: u8::from_le_bytes(*amount),
            eyes: u32::from_le_bytes(*amount),
    ...
    fn pack_into_slice(&self, dst: &mut [u8]) {
        ...
        let (
            ...
            eyes_dst,
            owner_dst
        ) = array_refs![dst, 1, 8, 8, 8, 8, 8, 8, 32, 8, 32, 32];
        ...
        is_initialized_dst.copy_from_slice(is_initialized.as_ref());
